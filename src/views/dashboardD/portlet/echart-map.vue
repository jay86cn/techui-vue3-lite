...
import shenyangMap from "./map/shenyangEn.json"
...
const initChart=()=>{
  state.chartData.alladcode=shenyangMap;
  state.chartData.geoJson=shenyangMap;
  state.chartData.geoJson.code=0
  state.chartData.geoJson.name="shenyangMap"
  echarts.registerMap("shenyangMap", shenyangMap);
...
const getMapData=()=>{
  let mapData = [],pointData=[] ,pinData = [], circleData = [],warningData = [],dangerData = [], sum = 0,
      topIndex=[12,8,6,7,11,14],warnIndex=[13,5],dangerIndex=[9];
