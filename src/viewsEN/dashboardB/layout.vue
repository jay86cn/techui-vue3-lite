...
const state=reactive({
  ...
  areas:[
    {name: "left", portlets: [
      {id:"l2",title:"Team Sales Completion",component:"echartsPictorialBar",border:"aYinTechBorderA1",hideTitle:true},
      {id:"l3",title:"Business Income",component:"echartBar",border:"aYinTechBorderA1",hideTitle:true},
      {id:"l1",title:"Budget vs Actual",component:"echartsRadar",border:"aYinTechBorderA1",hideTitle:true},
    ]},
    {name: "center", portlets: [
      {id:"c1",title:"Sales",component:"counterGrid",border:"blank",hideTitle:true},
      {id:"c2",title:"Task Completion",component:"echartPie",border:"aYinTechBorderA1",hideTitle:true},
      {id:"c3",title:"Proportion of profit",component:"echartGaugeTriple",border:"aYinTechBorderA1",hideTitle:true},
      {id: "c4", title: "Contract Situation", component: "echartBarLine", border: "aYinTechBorderB4"},
    ]},
    {name: "right", portlets: [
      {id:"r1",title:"Sales Situation",component:"echartLine",border:"aYinTechBorderA1",hideTitle:true},
      {id:"r2",title:"Revenue Expenditure",component:"echartBarHoriz",border:"aYinTechBorderA1",hideTitle:true},
      {id:"r3",title:"Task Completion",component:"echartBarHorizScroll",border:"aYinTechBorderA1",hideTitle:true},
    ]},
...
<template>
  <div class="screen1080B">
    ...
    <systemTitleA1 :config="systemTitleConfig">TechUI Data Visualization Tool</systemTitleA1>
  </div>
</template>
<style lang="less">
