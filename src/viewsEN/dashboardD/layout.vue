...
const state=reactive({
  ...
  areas:[
    {name:"left",portlets:[
      {id:"l2",title:"In & Out",component:"echartBarHoriz",border:"aYinTechBorderA1",hideTitle:true},
      {id:"l3",title:"Revenue",component:"echartLine",border:"aYinTechBorderA1",hideTitle:true},
      {id:"l1",title:"Sales tasks",component:"echartBarHorizScroll",border:"aYinTechBorderA1",hideTitle:true},
    ]},
    {name:"right",portlets:[
...
<template>
  <div class="screen1080D">
    ...
    <systemTitleA2 :config="systemTitleConfig">TechUI Data Visualization Tool</systemTitleA2>
    <echartMap></echartMap>
  </div>
</template>
<style lang="less">
